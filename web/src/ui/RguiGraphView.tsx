  ...
  const rgGraph = useMemo(() => {
    ...
    if (renderNodeOverlay) {
      ...
      for (const n of g.nodes) {
        ...
        const full = vt === "textarea" || vt === "url" || vt === "screen-share" || vt === "camera" || vt === "vision-model" || vt === "qwen-image" || vt === "depth-field" || vt === "hand-space" || vt === "spatial-renderer" || vt === "image-match" || vt === "ar-notes";
