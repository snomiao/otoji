...
const PORT_COLOR: Record<PortType, string> = { segment: "#dd6b20", transcript: "#2b6cb0", image: "#319795", control: "#d69e2e", environment: "#6b7280" };
const KIND_LABEL: Record<PortType, string> = { segment: "voice", transcript: "transcript", image: "frames", control: "feedback", environment: "environment" };
